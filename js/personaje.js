...
TIA_array.push(new Personaje('Súper', './images/personajes/foto_3.jpg', 201, 50, '¡ Te lanza una caja fuerte....', 'Lanza su zapato...'));
TIA_array.push(new Personaje('Bacterio', './images/personajes/foto_4.jpg', 190, 50, '¡ Te ha clavado una jeringuilla....', 'Te lanza una probeta tóxica...'));
...
TIA_array.push(new Personaje('Bestiajez', './images/personajes/foto_8.jpg', 260, 50, '¡ En toda la cara con el puño !...', 'Puñetazo a lo Bud Spencer...'));
...
AMPA_array.push(new Personaje('TodoQuisque', './images/personajes/foto_11.jpg', 240, 50, '¡ Mamporro que te crio !...', 'Lanza un gato rabioso...'));
AMPA_array.push(new Personaje('El Rabadillo', './images/personajes/foto_12.jpg', 180, 50, '¡ Saca su metralleta y te dispara !...', 'Te lanza una piedra con tirachinas...'));
AMPA_array.push(new Personaje('Doctor Bacilez', './images/personajes/foto_13.jpg', 230, 50, '¡ Te arroja un líquido pringoso !...', 'Ataca con porra vieja.......'));
...
AMPA_array.push(new Personaje('Doctor Bichez', './images/personajes/foto_15.jpg', 220, 50, '¡ Te lanza una bolsa de bichos venenosos !...', 'Ataca con porra vieja....'));
AMPA_array.push(new Personaje('Magin el Mago', './images/personajes/foto_16.jpg', 190, 50, '¡ Saca de su sombrero una palanca y te golpea !....', 'Te ataca con porra vieja....'));
